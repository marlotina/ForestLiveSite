...
export const environment = {
  ...
  whiteListDomains:  ["postapiqa.azurewebsites.net", "userapiqa.azurewebsites.net","birdsapiqa.azurewebsites.net","commentsapi.azurewebsites.net", "userpostapiqa.azurewebsites.net"],
  blacklistedRoutes: []
}
/*
